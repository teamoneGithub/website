<?php
	...
	$EXT = '.jpg';
	$imgs = array($BASE . "CqmBjo5" . $EXT, $BASE . "zkaAooq" . $EXT, $BASE . "0gqnEaY" . $EXT,
	...
	for($i=0; $i<count($imgs); $i++){
		$content = file_get_contents($imgs[$i]);
		echo $imgs[$i];	
		//$fp = fopen("/gaia/home/project/teamone/html/AndroidUploadImage/uploads/", "w");
	}
?>
